...
namespace BasicEvent
{
    ...
    public class OnCollision2D_Stay
    {
        ...
        {
            BasicEvent.Core.Method.Add<Component.OnCollision2D_Stay_Component, Collision2D>(gameObject, action);
        }
        public static void Remove(GameObject gameObject, Action<Collision2D> action)
        {
            BasicEvent.Core.Method.Remove<Component.OnCollision2D_Stay_Component, Collision2D>(gameObject, action);
        }
