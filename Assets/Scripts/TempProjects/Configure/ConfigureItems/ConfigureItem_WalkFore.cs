...
namespace Configure.ConfigureItems
{
    ...
    public class ConfigureItem_WalkFore : ConfigureItem
    {
        ...
        [Tooltip("")]
        public Configure.Inspector.DataNameDropDown<float> 移动指令 = new Configure.Inspector.DataNameDropDown<float>(EventData.DataName.Preset.PresetName.全局_输入_移动横向值);
        [Tooltip("")]
        ...
        [Tooltip("")]
        public Configure.Inspector.DataNameDropDown<Vector2> 运动速度 = new Configure.Inspector.DataNameDropDown<Vector2>(EventData.DataName.Preset.PresetName.运动速度向量);
        ...
        [Tooltip("")]
        public Configure.Inspector.DataNameDropDown<Vector2> 行走施力 = new Configure.Inspector.DataNameDropDown<Vector2>(EventData.DataName.Preset.PresetName.行走施力);
